...
from app.controllers.printer import printer
from app.controllers.login import login
from app.controllers.document_share import document_share
# from app.controllers.daoinkpay import daoinkpay
...
# app.register_blueprint(daoinkpay)D
